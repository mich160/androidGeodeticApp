...
public class RefSystemConvTest {
    ...
    public void convertTest() {
        ...
        try {
            ...
            Coordinates2D resultCoordinates = converter.convert(wsg84Coordinates, ReferenceSystemConverter.ReferenceSystem.WS84, GS2000RefSystemPicker.getReferenceSystem(wsg84Coordinates.getX()));
            ...
            resultCoordinates = converter.convert(wsg84Coordinates, ReferenceSystemConverter.ReferenceSystem.WS84, GS2000RefSystemPicker.getReferenceSystem(wsg84Coordinates.getX()));
            ...
            //REVERSE TEST
            Coordinates2D gs2000z8Coordinates = new Coordinates2D(expectedZ8X, expectedZ8Y);
            resultCoordinates = converter.convert(gs2000z8Coordinates, ReferenceSystemConverter.ReferenceSystem.CS2000z8, ReferenceSystemConverter.ReferenceSystem.WS84);
        ...
        } catch (ReferenceSystemConvertException e) {
            e.printStackTrace();
        }
    }
